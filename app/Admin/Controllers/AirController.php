...
class AirController extends Controller
{
    ...
    public function edit($id)
    {
        return Admin::content(function (Content $content) use ($id) {
            ...
            $content->header('Ubah ');
            $content->description('Pemakaian Air');
    ...
    {            $roles      = Admin::user()->roles;
        ...
        return Admin::grid(Air::class, function (Grid $grid) use ($DataAset) {
            ...
            $grid->column('Pemakaian (m3)')->display(function(){
    ...
    {
        return Admin::form(Air::class, function (Form $form) {
            ...
            $form->number('pemakaian' , 'Pemakaian (m3)')->rules('required');
            ...
            $form->image('foto_after' , 'Foto Sesudah');
    ...
    public function generate_pemakaian()
    {
        ...
        foreach ($DataAir as $key => $value) {
            ...
            else
            {
                ...
                $insert_data->jenis_pemakaian     = 'Air';
