...
class ListrikController extends Controller
{
    ...
    public function index()
    {
        ...
        return Admin::content(function (Content $content) {
            ...
            $content->header('Pemakaian Listrik');
            $content->description('');
    ...
    protected function grid()
    {
        ...
        return Admin::grid(Listrik::class, function (Grid $grid) use ($DataAset) {
            ...
            $grid->column('Pemakaian (KWH)')->display(function(){
    ...
    {
        return Admin::form(Listrik::class, function (Form $form) {
            ...
            $form->number('pemakaian' , 'Pemakaian (Kwh)')->rules('required');
    ...
    public function generate_pemakaian()
    {
        ...
        $DataListrik = Listrik::all();
        foreach ($DataListrik as $key => $value) {
            ...
            else
            {
                ...
                $insert_data->jenis_pemakaian     = 'Listrik';
    ...
    public function generate_wilayah()
    {
        ...
        foreach ($DataPemakaian as $key => $value) {
            ...
            $insert->jenis_pemakaian = 'Listrik';
